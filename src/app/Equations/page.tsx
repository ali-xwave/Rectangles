    ...
    return (
      <div>
        ...
        <div style={{ marginTop: '10px' }}>
          <button onClick={() => this.insertText('→')} className="toolbar-button" style={{ marginRight: '10px' }}>
            {'→'}
          </button>
          <button onClick={this.logEquation} className="toolbar-button" style={{ marginRight: '10px' }}>
            Log Equation
          </button>
